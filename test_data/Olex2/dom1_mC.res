...
Q5    1   0.3879  0.5000  0.3570  10.50000  0.05    2.82
  ...
  REM
  REM R1 = 0.1629 for 285 Fo > 4sig(Fo) and 0.1818 for all 454 data
  REM 35 parameters refined using n/a restraints
  REM Highest difference peak 3.85, deepest hole -3.70
  REM Mean Shift 0.001, Max Shift -0.004.
  ...
  REM Reflections_all = 454
  REM Reflections_gt = 285
  REM Parameters = 35
  REM Hole = -3.70
  REM Peak = 3.85
  REM Flack = n/a
